...
for ind, spikes1 in enumerate(spikes):
    ...
    tp2.build_binned_file_quick(tspikes, ttrials, tclust, windt, fs, ['Good'], period, '/home/brad/pcsim/placecellsimdatcuda{}.binned'.format(ind), dt_overlap=dtovr)

# compute simplicial complexes
    print('Computing simplicial complexes...')
    with h5.File('/home/brad/pcsim/placecellsimdatcuda{}.binned'.format(ind), 'r') as bf:
...
print('Saving...')
with open(os.path.join(figsavepth,'environment_out_random_place_fields_cuda_{}_{}_{}.pkl'.format(ntrials, max_hole, nrepeats)), 'wb') as f:
