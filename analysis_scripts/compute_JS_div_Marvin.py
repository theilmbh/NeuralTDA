...
for block in blocks:
            ...
            spectra = []
            laplacians_save = []
            print('Computing Laplacians for {}...'.format(block))
            ...
            with open(os.path.join(figsavepth, 'Mspectra_{}.pkl'.format(block)), 'wb') as f:
                pickle.dump(M_spec, f)
            with open(os.path.join(figsavepth, 'Laplacians_{}.pkl'.format(block)), 'wb') as f:
                pickle.dump(laplacians_save, f)
            with open(os.path.join(figsavepth, 'Lapspectra_{}.pkl'.format(block)), 'wb') as f:
